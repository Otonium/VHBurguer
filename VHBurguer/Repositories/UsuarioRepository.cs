...
namespace VHBurguer.Repositories
{
    public class UsuarioRepository : IUsuarioRepository
    {
        ...
        public UsuarioRepository(VH_BurguerContext context) //famoso "construtor"
        {
            _context = context;
        }
        ...
        {
            return _context.Usuario.FirstOrDefault(usuario => usuario.Email == email); // (var_auxiliar)
        }

        public bool EmailExiste(string email)
        {
            // Any -> retorna um true ou false para validar se existe ALGUM usuário com esse e-mail
